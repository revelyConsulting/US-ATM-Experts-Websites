...
pa["body"] = sub_hero(pa,"Vaulting partner program","Add revenue to your ATM route by vaulting our locations","US ATM Experts is looking for established independent ATM operators in every state. We sign the locations. You place your own machine, supply and load the cash, and keep it running — and earn a share of every surcharge. No franchise fees, no royalties.","hero-skyline.svg",crumbs=[("Partners",None)],extra='<div class="btn-row"><a class="btn btn-light" href="#apply">Apply now</a></div>') + f"""
