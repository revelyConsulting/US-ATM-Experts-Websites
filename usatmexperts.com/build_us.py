...
OUT = sys.argv[1] if len(sys.argv)>1 else "multistate/usatmexperts.com"
...
<div class="topbar"><div class="wrap">
  ...
  <div class="social">Serving all 50 states</div>
</div></div>
...
<footer><div class="wrap">
 <div class="grid grid-5">
  <div>
   <a class="brand" href="{r}index.html"><img src="{LOGO_R}" alt="" width="58" height="58" loading="lazy"><span><strong>{BRAND}</strong><small>Serving all 50 states</small></span></a>
...
ORG = {
 ...
 "name":BRAND,"alternateName":"United States ATM Experts","url":BASE+"/",
 "logo":LOGO,
 "image":LOGO,
 "telephone":PHONE_TEL,"email":EMAIL,
 "description":"Free ATM placement, ATM processing, ATM sales, and a vaulting partner program for independent operators — in all 50 states.",
 ...
 "slogan":"Free ATM placement, processing, and sales in all 50 states",
 ...
 "contactPoint":{"@type":"ContactPoint","telephone":PHONE_TEL,"contactType":"sales","areaServed":"US","availableLanguage":"English"},
...
def service_ld(name, url, desc, stype="Service"):
    return {"@context":"https://schema.org","@type":stype,"name":name,"url":url,"description":desc,
            "provider":{"@id":BASE+"/#business"},"areaServed":{"@type":"Country","name":"United States"}}
...
home = {
 "path":"index.html",
 "title":"US ATM Experts | Free ATM Placement, Processing & ATM Sales Nationwide",
 "desc":f"{BRAND} offers free ATM placement, ATM processing, and Genmega & Hyosung ATM sales in all 50 states, plus a vaulting partner program for ATM operators. Call {PHONE_DISPLAY}.",
...
<div class="hero"><div class="bg" style="background-image:url('_assets/_images/hero-storefronts.svg');opacity:.5"></div><div class="wrap"><div class="hero-grid">
 <div>
  <span class="eyebrow">National ATM company · Serving all 50 states</span>
  <h1>America's ATM company for free ATM placement and ATM sales</h1>
...
<div class="trust"><div class="wrap"><span>Serving all 50 states</span><span>Genmega & Hyosung authorized dealer</span><span>Trusted by hospitality &amp; retail businesses</span><span>Free processing on every machine</span></div></div>

<section><div class="wrap">
 <div class="section-head"><span class="eyebrow">What we do</span><h2>ATM solutions for businesses in every state</h2><p class="lead">Whether you want a machine placed for free or want to own your own ATM and keep 100% of the surcharge, we handle every part of the operation.</p></div>
...
<section class="alt"><div class="wrap"><div class="split">
 <div>
  ...
  <p>{BRAND} is trusted in all 50 states by business owners who need an ATM that simply works. We've placed machines in {DISP_WORD}restaurants, bars, hotels, tattoo shops, barbershops, and city facilities, and we back every one with best in class support.</p>
  <p>Whether you need <a href="atm-placement.html">free ATM placement</a> anywhere in the country, {DISP_LINK_HOME}<a href="atm-processing.html">ATM processing</a> for a machine you already own, or a <a href="equipment.html">new Genmega or Hyosung ATM</a> for your business, one national team handles it.</p>
  <ul class="checks">
 ...
 <img src="_assets/_images/service-map.svg" alt="US ATM Experts service area: all 50 states" width="1200" height="900" loading="lazy">
</div></div></section>
...
<section class="dark"><div class="wrap"><div class="split">
 <div>
  ...
  <div class="btn-row"><a class="btn btn-light" href="partners.html">See the partner program →</a><a class="btn btn-outline" style="border-color:#fff;color:#fff" href="partners.html#apply">Apply now</a></div>
 </div>
...
PL_FAQ = [
 ...
 ("How much will the surcharge be?", "<p>At setup we analyze your location to determine the best surcharge and maximum withdrawal amount for your customers. Most locations run between $3.50 and $4.00.</p>"),
...
pl = {
 ...
 "title":"Free ATM Placement Nationwide | US ATM Experts",
 ...
 "ld":[service_ld("Free ATM placement", BASE+"/atm-placement.html",f"Turnkey ATM placement program for businesses in all 50 states at no cost: installation, cash loading, monitoring, and a surcharge revenue share."), faq_ld(PL_FAQ), crumbs_ld([("Home","index.html"),("Free ATM Placement","atm-placement.html")])],
}
pl["body"] = sub_hero(pl,"Free ATM placement nationwide","Free ATM placement for businesses in all 50 states — installed, stocked, and monitored by us","Are you a business owner interested in a turnkey ATM solution placed free of charge at your place of business? Our no-cost, full-service program means we take on every expense and every task. You collect a share of the surcharge every month.","hero-skyline.svg",crumbs=[("Free ATM Placement",None)],extra=f'<div class="btn-row"><a class="btn btn-light" href="tel:{PHONE_TEL}">Call {PHONE_DISPLAY}</a></div>') + f"""
...
<section><div class="wrap"><div class="split">
 ...
 <div>
  ...
  <h2>The best locations for a placed ATM</h2>
  <p>We've placed machines everywhere from big-city bars to small-town city halls. The common thread is steady foot traffic and customers who like to pay cash. Strong candidates include:</p>
  <ul class="checks">
...
<section><div class="wrap"><div class="section-head"><span class="eyebrow">Placement vs. ownership</span><h2>Should you take a free placement or buy your own ATM?</h2></div>
 <div class="grid grid-2">
  ...
  <div class="card"><h3>Buy or lease</h3><p>Best if you have the capital and want to keep 100% of the surcharge. Every machine we sell includes free processing, free shipping, 24/7 support, and next-day deposits.</p><a class="more" href="equipment.html">See ATM pricing →</a></div>
 </div>
</div></section>

<section><div class="wrap"><div class="section-head"><span class="eyebrow">National reach, local service</span><h2>Why businesses choose {BRAND}</h2></div>
 <div class="grid grid-3">
  ...
  <div class="card"><h3>Built for local traffic patterns</h3><p>Tourist seasons, sports schedules, and regional holidays all change how much cash a location needs. Our cash load prediction software learns each location's pattern so the machine is stocked for the rush and not over-loaded in the lull.</p></div>
  <div class="card"><h3>One company for every ATM need</h3><p>Free placement, {DISP_LINK_PL}<a href="atm-processing.html">ATM processing</a>, and <a href="equipment.html">Genmega and Hyosung machines for sale</a> — all from one national team you can reach by phone.</p></div>
 </div>
</div></section>
...
{states_block(heading="Free ATM placement in every state")}
...
di = {
 ...
 "title":"Dispensary ATMs Nationwide | Compliant Cannabis ATM Placement",
 "desc":"100% compliant ATMs for dispensaries in every legal state. Customer bank statements show your dispensary's real name and address. Free placement, cash loading, and monitoring from the largest cannabis ATM company in the country.",
 "ld":[service_ld("Dispensary ATM placement", BASE+"/dispensaries.html",f"Compliant ATM placement, cash management, and processing for cannabis dispensaries nationwide, with the dispensary's real name and address on every customer bank statement."), faq_ld(DI_FAQ), crumbs_ld([("Home","index.html"),("Dispensary ATMs","dispensaries.html")])],
}
di["body"] = sub_hero(di,"Dispensary ATMs","100% compliant ATMs for dispensaries nationwide","Cash is still king in cannabis. We're the largest cannabis ATM company in the country, and every machine we place runs fully compliant — with your dispensary's real name and address showing on your customers' bank statements.","dispensary-hero.svg",crumbs=[("Dispensary ATMs",None)],extra=f'<div class="btn-row"><a class="btn btn-light" href="tel:{PHONE_TEL}">Call {PHONE_DISPLAY}</a></div>') + f"""
...
{states_block(heading="Dispensary ATMs in every legal state")}
...
pr = {
 ...
 "title":"ATM Processing for ATM Owners Nationwide | US ATM Experts",
 "desc":f"Free ATM processing with daily deposits and real-time online reporting, included with every ATM we sell or place, in all 50 states. Keep 100% of the surcharge on owned machines.",
 "ld":[service_ld("ATM processing", BASE+"/atm-processing.html",f"ATM transaction processing with daily deposits and real-time online reporting for ATM owners in all 50 states."), faq_ld(PR_FAQ), crumbs_ld([("Home","index.html"),("ATM Processing","atm-processing.html")])],
}
pr["body"] = sub_hero(pr,"ATM processing","ATM processing with daily vault cash deposits and real-time reporting",f"{BRAND} provides free ATM processing with each ATM we sell. No more waiting days for your vault cash funds, and no more guessing how much money is remaining in your ATM.","hero-processing.svg",crumbs=[("ATM Processing",None)]) + f"""
...
eq = {
 "path":"equipment.html",
 "title":"ATM Machines for Sale | Genmega & Hyosung Dealer | US ATM Experts",
 "desc":f"ATM machines for sale nationwide: Genmega and Nautilus Hyosung ATMs from {BRAND}. Every machine includes free processing, free shipping, and 100% of the surcharge.",
...
eq["body"] = sub_hero(eq,"ATM sales nationwide","Buy an ATM and keep 100% of the surcharge",f"{BRAND} is an authorized Genmega and Nautilus Hyosung dealer shipping to all 50 states. We'll walk you through the entire process, from choosing a model to your first deposit.","hero-equipment.svg",crumbs=[("Buy an ATM",None)]) + f"""
...
"""
    return pg
pass  # no city pages on the national hub
...
pa["body"] = sub_hero(pa,"Vaulting partner program","Add revenue to your ATM route by vaulting our locations","US ATM Experts is looking for established independent ATM operators in every state. We sign the locations. You place your own machine, supply and load the cash, and keep it running — and earn a share of every surcharge. No franchise fees, no royalties.","hero-storefronts.svg",crumbs=[("Partners",None)],extra='<div class="btn-row"><a class="btn btn-light" href="#apply">Apply now</a></div>') + f"""
...
for n in want:
    ...
    t=t.replace("Phoenix, AZ 85004",f"{METRO}, {ABBR_SVG}").replace("PHOENIX AZ 85004",f"{METRO.upper()} {ABBR_SVG}").replace("PHOENIX, AZ 85004",f"{METRO.upper()}, {ABBR_SVG}").replace("Phoenix AZ",f"{METRO} {ABBR_SVG}").replace("PHOENIX AZ",f"{METRO.upper()} {ABBR_SVG}")
    t=t.replace("Tempe AZ",f"{c2} TX").replace("Mesa AZ",f"{c3} IL").replace("Scottsdale AZ",f"{c4} WA").replace("Phoenix",METRO)
...
pins=[{"name":n} for n in ["Seattle","Denver","Chicago","New York","Los Angeles","Dallas","Atlanta","Miami"]]; pos=[(560,300),(700,380),(480,440),(640,520),(760,250),(420,330),(700,600),(520,600)]
pinsvg="".join(f'<use href="#pin" transform="translate({x},{y})"/><text x="{x+20}" y="{y-28}">{esc(c["name"])}</text>' for c,(x,y) in zip(pins,pos))
svg=f'''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 900" role="img" aria-labelledby="t"><title id="t">US ATM Experts service area: all 50 states</title>
...
<g filter="url(#sh)"><rect x="70" y="620" width="330" height="140" rx="18" fill="#fff"/><text x="94" y="656" fill="#5b6172" font-family="Inter,Arial" font-size="12" font-weight="700" letter-spacing="1.5">SERVICE AREA</text><text x="94" y="694" fill="{P}" font-family="Inter,Arial" font-size="24" font-weight="800">All 50 states</text><text x="94" y="724" fill="#5b6172" font-family="Inter,Arial" font-size="14">Placed, cash-loaded, and serviced</text></g>
<g filter="url(#sh)"><rect x="880" y="560" width="250" height="200" rx="18" fill="#fff"/><text x="904" y="596" fill="#5b6172" font-family="Inter,Arial" font-size="12" font-weight="700" letter-spacing="1.5">NATIONAL HQ</text><text x="904" y="640" fill="{A}" font-family="Inter,Arial" font-size="26" font-weight="800">US ATM Experts</text><text x="904" y="676" fill="{P}" font-family="Inter,Arial" font-size="15" font-weight="700">Nationwide network</text><text x="904" y="700" fill="#5b6172" font-family="Inter,Arial" font-size="14">Local teams + vaulting partners</text></g>
</svg>'''
