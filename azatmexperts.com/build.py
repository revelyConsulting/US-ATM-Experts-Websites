...
BASE = "https://www.azatmexperts.com"
PHONE_DISPLAY = "602.688.7447"
PHONE_TEL = "+16026887447"
EMAIL = "info@azatmexperts.com"
BRAND = "Arizona ATM Experts"
...
AREAS = ["Phoenix","Scottsdale","Tempe","Mesa","Chandler","Gilbert","Glendale","Peoria","Surprise","Goodyear","Avondale","Buckeye","Litchfield Park","Tolleson","El Mirage","Sun City","Fountain Hills","Paradise Valley","Cave Creek","Carefree","Anthem","Apache Junction","San Tan Valley","Queen Creek","Maricopa","Casa Grande","Prescott","Prescott Valley","Chino Valley","Sedona","Flagstaff","Tucson"]
...
def head(p, depth=0):
    ...
    og_img = f"{BASE}/_assets/_images/_state_logo/az-puck-logo.png"
...
<meta property="og:site_name" content="Arizona ATM Experts">
...
<link rel="icon" href="{r}_assets/_images/_state_logo/az-puck-logo.png">
<link rel="apple-touch-icon" href="{r}_assets/_images/_state_logo/az-puck-logo.png">
...
<div class="topbar"><div class="wrap">
  ...
  <div class="social">Serving all of Arizona</div>
</div></div>
<header class="site"><div class="wrap">
  <a class="brand" href="{r}index.html"><img src="{r}_assets/_images/_state_logo/az-puck-logo.png" alt="Arizona ATM Experts logo" width="58" height="58"><span><strong>Arizona ATM Experts</strong><small>ATM placement · processing · sales</small></span></a>
...
<footer><div class="wrap">
 <div class="grid grid-5">
  <div>
   <a class="brand" href="{r}index.html"><img src="{r}_assets/_images/_state_logo/az-puck-logo.png" alt="" width="58" height="58" loading="lazy"><span><strong>Arizona ATM Experts</strong><small>Serving all of Arizona</small></span></a>
   <p>Free ATM placement, ATM processing, and equipment sales for Arizona businesses since 2012. Locally owned and operated in the Phoenix metro area.</p>
  </div>
  <div><h4>Services</h4><ul>
   <li><a href="{r}atm-placement.html">Free ATM Placement</a></li>
   <li><a href="{r}dispensaries.html">Dispensary ATMs</a></li>
  ...
  <div><h4>Service areas</h4><ul>
   <li><a href="{r}locations/phoenix.html">Phoenix</a> · <a href="{r}locations/scottsdale.html">Scottsdale</a> · <a href="{r}locations/tempe.html">Tempe</a></li>
   <li><a href="{r}locations/mesa.html">Mesa</a> · <a href="{r}locations/chandler.html">Chandler</a> · <a href="{r}locations/gilbert.html">Gilbert</a></li>
   <li><a href="{r}locations/glendale.html">Glendale</a> · <a href="{r}locations/peoria.html">Peoria</a> · <a href="{r}locations/surprise.html">Surprise</a></li>
   <li><a href="{r}locations/tucson.html">Tucson</a> · <a href="{r}locations/prescott.html">Prescott</a> · <a href="{r}locations/flagstaff.html">Flagstaff</a></li>
  </ul></div>
  <div><h4>Contact</h4><ul>
   <li><a href="tel:{PHONE_TEL}">{PHONE_DISPLAY}</a></li>
   <li><a href="mailto:{EMAIL}">{EMAIL}</a></li>
   <li>Phoenix, Arizona · serving statewide</li>
  </ul></div>
 </div>
{network_block("AZ")}
 <div class="bottom">
  <div>© <span id="year">2026</span> Arizona ATM Experts. All rights reserved. Part of <a href="https://www.usatmexperts.com" target="_blank" rel="noopener">US ATM Experts</a>.</div>
...
CITY_SLUGS = {"Phoenix":"phoenix","Scottsdale":"scottsdale","Tempe":"tempe","Mesa":"mesa","Chandler":"chandler","Gilbert":"gilbert","Glendale":"glendale","Peoria":"peoria","Surprise":"surprise","Goodyear":"goodyear","Queen Creek":"queen-creek","Casa Grande":"casa-grande","Tucson":"tucson","Prescott":"prescott","Sedona":"sedona","Flagstaff":"flagstaff"}
def areas_block(depth=0, heading="Serving businesses across Arizona"):
    r = rel(depth)
    ...
    return f"""<section class="alt"><div class="wrap"><div class="section-head"><span class="eyebrow">Service area</span><h2>{heading}</h2><p class="lead">We're based in the Phoenix metro area and place, service, and cash-load ATMs statewide. If your business is in Arizona, we can help.</p></div><div class="areas">{chips}</div></div></section>"""
...
ORG = {
 ...
 "name":"Arizona ATM Experts","alternateName":"AZ ATM Experts","url":BASE+"/",
 "logo":BASE+"/_assets/_images/_state_logo/az-puck-logo.png",
 "image":BASE+"/_assets/_images/_state_logo/az-puck-logo.png",
 "telephone":PHONE_TEL,"email":EMAIL,"foundingDate":"2012",
 "description":"Free ATM placement, ATM processing, and ATM sales for businesses across Arizona.",
 "address":{"@type":"PostalAddress","addressLocality":"Phoenix","addressRegion":"AZ","addressCountry":"US"},
 "areaServed":[{"@type":"State","name":"Arizona"}]+[{"@type":"City","name":a} for a in AREAS],
 "parentOrganization":{"@type":"Organization","name":"US ATM Experts","url":"https://www.usatmexperts.com"},
 "slogan":"Free ATM placement, processing, and sales across Arizona",
 ...
 "contactPoint":{"@type":"ContactPoint","telephone":PHONE_TEL,"contactType":"sales","areaServed":"US-AZ","availableLanguage":"English"},
 ...
 "hasOfferCatalog":{"@type":"OfferCatalog","name":"ATM services","itemListElement":[
   ...
   {"@type":"Offer","itemOffered":{"@type":"Service","name":"Dispensary ATM placement","url":BASE+"/dispensaries.html"}},
...
def service_ld(name, url, desc, stype="Service"):
    return {"@context":"https://schema.org","@type":stype,"name":name,"url":url,"description":desc,
            "provider":{"@id":BASE+"/#business"},"areaServed":{"@type":"State","name":"Arizona"}}
...
PORTFOLIO_FORM = float_panel("Get a quote","Move your portfolio","Tell us about your terminals","We'll come back with interchange and processing terms for your portfolio, usually within two business days.",f"Portfolio processing inquiry ({BRAND})",[
 ...
 ("pf-state","State",'<select id="pf-state" name="state" required autocomplete="address-level1"><option value="AZ" selected>AZ</option></select>',False),
...
HOME_FAQ = [
 ...
 ("How do I find a reliable ATM company near me in Arizona?", "<p>Look for a company that owns its routes, loads its own cash, and answers the phone. Arizona ATM Experts is locally owned in the Phoenix metro area, has placed and serviced ATMs across Arizona since 2012, and is an authorized Genmega and Nautilus Hyosung dealer. Call 602.688.7447 and you'll reach our local team.</p>"),
 ("What areas of Arizona do you serve?", "<p>All of it. We're headquartered in the Phoenix metro area and service the entire Valley — Scottsdale, Tempe, Mesa, Chandler, Gilbert, Glendale, Peoria, Surprise, Goodyear, and more — plus Prescott, Prescott Valley, Chino Valley, Sedona, Flagstaff, Tucson, and everywhere in between.</p>"),
]
home = {
 "path":"index.html",
 "title":"Arizona ATM Company | Free ATM Placement & Sales | Phoenix",
 "desc":"Arizona ATM Experts is a Phoenix-based ATM company offering free ATM placement, ATM processing, and Genmega & Hyosung ATM sales across Arizona. Locally owned since 2012. Call 602.688.7447.",
 "ld":[ORG, {"@context":"https://schema.org","@type":"WebSite","url":BASE+"/","name":"Arizona ATM Experts","publisher":{"@id":BASE+"/#business"}}, faq_ld(HOME_FAQ)],
}
home["body"] = f"""
<div class="hero"><div class="bg" style="background-image:url('_assets/_images/hero-storefronts.svg');opacity:.5"></div><div class="wrap"><div class="hero-grid">
 <div>
  <span class="eyebrow">Phoenix-based · Serving all of Arizona</span>
  <h1>Arizona's ATM company for free ATM placement and ATM sales</h1>
...
<div class="trust"><div class="wrap"><span>Arizona owned & operated</span><span>Hyosung & Genmega authorized dealer</span><span>Trusted by Arizona cities &amp; hospitality venues</span><span>Free processing on every machine</span></div></div>

<section><div class="wrap">
 <div class="section-head"><span class="eyebrow">What we do</span><h2>ATM solutions for Arizona businesses</h2><p class="lead">Whether you want a machine placed for free or want to own your own ATM and keep 100% of the surcharge, we handle every part of the operation.</p></div>
 <div class="grid grid-3">
...
<section class="alt"><div class="wrap"><div class="split">
 <div>
  <span class="eyebrow">Why Arizona ATM Experts</span>
  <h2>Reliable machines, backed by second-to-none service</h2>
  <p>Arizona ATM Experts is trusted across Arizona by business owners who need an ATM that simply works. We've placed machines in dispensaries, restaurants, bars, hotels, tattoo shops, barbershops, and city facilities across the state, and we back every one with best in class support.</p>
  <p>Whether you need <a href="atm-placement.html">free ATM placement</a> in Phoenix, a <a href="dispensaries.html">compliant dispensary ATM</a> in Tucson, <a href="atm-processing.html">ATM processing</a> for a machine you already own, or a <a href="equipment.html">new Genmega or Hyosung ATM</a> for your business, one local Arizona team handles it.</p>
  <ul class="checks">
 ...
 <img src="_assets/_images/arizona-service-map.svg" alt="Map of Arizona showing ATM service locations in Phoenix, Scottsdale, Mesa, Prescott, Flagstaff, Sedona, Tucson, and Casa Grande" width="1200" height="900" loading="lazy">
</div></div></section>
...
PL_FAQ = [
 ...
 ("How much will the surcharge be?", "<p>At setup we analyze your location to determine the best surcharge and maximum withdrawal amount for your customers. Most Arizona locations run between $3.50 and $4.00.</p>"),
 ...
 ("Do you offer ATM placement near me in Arizona?", "<p>If your business is in Arizona, almost certainly yes. We're headquartered in the Phoenix metro area and run regular routes through Scottsdale, Tempe, Mesa, Chandler, Gilbert, Glendale, Peoria, Tucson, Prescott, Sedona, and Flagstaff. See our <a href=\"locations/phoenix.html\">Phoenix</a>, <a href=\"locations/scottsdale.html\">Scottsdale</a>, and <a href=\"locations/tucson.html\">Tucson</a> pages, or call and ask about your city.</p>"),
...
pl = {
 ...
 "title":"Free ATM Placement in Phoenix & Arizona | Arizona ATM Experts",
 "desc":"Get a free ATM at your Arizona bar, restaurant, hotel, or store. We install, load the cash, and monitor it at no cost — you earn a monthly surcharge share. Phoenix & statewide.",
 "ld":[service_ld("Free ATM placement", BASE+"/atm-placement.html","Turnkey ATM placement program for Arizona businesses at no cost: installation, cash loading, monitoring, and a surcharge revenue share."), faq_ld(PL_FAQ), crumbs_ld([("Home","index.html"),("Free ATM Placement","atm-placement.html")])],
}
pl["body"] = sub_hero(pl,"Free ATM placement in Arizona","Free ATM placement for Phoenix and Arizona businesses — installed, stocked, and monitored by us","Are you a business owner interested in a turnkey ATM solution placed free of charge at your place of business? Our no-cost, full-service program means we take on every expense and every task. You collect a share of the surcharge every month.","hero-desert.svg",crumbs=[("Free ATM Placement",None)],extra=f'<div class="btn-row"><a class="btn btn-light" href="tel:{PHONE_TEL}">Call {PHONE_DISPLAY}</a></div>') + f"""
...
<section><div class="wrap">
 <div class="section-head"><span class="eyebrow">What's included</span><h2>Our no-cost, full-service ATM program</h2><p class="lead">Everything an ATM needs to run, handled by Arizona ATM Experts.</p></div>
 <div class="grid grid-4">
...
<section class="alt" id="earnings"><div class="wrap">
 <div class="section-head"><span class="eyebrow">Earnings estimates</span><h2>What a free ATM placement can pay your location</h2><p class="lead">Estimates are based on actual Arizona ATM Experts locations. Your numbers will vary with foot traffic and the surcharge we set together.</p></div>
...
<section><div class="wrap"><div class="split">
 ...
 <div>
  ...
  <h2>The best Arizona locations for a placed ATM</h2>
  <p>We've placed machines everywhere from Whiskey Row bars to city halls. The common thread is steady foot traffic and customers who like to pay cash. Strong candidates include:</p>
  <ul class="checks">
...
<section><div class="wrap"><div class="section-head"><span class="eyebrow">Local expertise</span><h2>Why Arizona businesses choose a local ATM company</h2></div>
 <div class="grid grid-3">
  <div class="card"><h3>Local cash routes, not a call center</h3><p>We're based in the Phoenix metro area and run our own cash and service routes across the Valley, Tucson, and Northern Arizona. When a machine needs attention, a local technician handles it — not a national dispatcher three time zones away.</p></div>
  <div class="card"><h3>Built for Arizona traffic patterns</h3><p>Spring training, snowbird season, university semesters, First Fridays, and summer slowdowns all change how much cash a location needs. Our cash load prediction software learns each location's pattern so the machine is stocked for the rush and not over-loaded in the lull.</p></div>
  <div class="card"><h3>One company for every ATM need</h3><p>Free placement, <a href="dispensaries.html">compliant dispensary ATMs</a>, <a href="atm-processing.html">ATM processing</a>, and <a href="equipment.html">Genmega and Hyosung machines for sale</a> — all from one Arizona team you can reach by phone.</p></div>
 </div>
</div></section>
...
{areas_block(heading="Free ATM placement across Arizona")}
...
DI_FAQ = [
 ...
 ("Do you serve dispensaries outside the Phoenix area?", "<p>Yes. We place and service dispensary ATMs across Arizona, including Tucson, Flagstaff, Prescott, Sedona, and the entire Phoenix metro.</p>"),
]
di = {
 "path":"dispensaries.html",
 "title":"Dispensary ATMs in Arizona | Compliant Cannabis ATM Placement",
 "desc":"100% compliant ATMs for Arizona dispensaries. Customer bank statements show your dispensary's real name and address. Free placement, cash loading, and monitoring from the largest cannabis ATM company in the country.",
 "ld":[service_ld("Dispensary ATM placement", BASE+"/dispensaries.html","Compliant ATM placement, cash management, and processing for cannabis dispensaries in Arizona, with the dispensary's real name and address on every customer bank statement."), faq_ld(DI_FAQ), crumbs_ld([("Home","index.html"),("Dispensary ATMs","dispensaries.html")])],
}
di["body"] = sub_hero(di,"Dispensary ATMs","100% compliant ATMs for Arizona dispensaries","Cash is still king in cannabis. We're the largest cannabis ATM company in the country, and every machine we place runs fully compliant — with your dispensary's real name and address showing on your customers' bank statements.","dispensary-hero.svg",crumbs=[("Dispensary ATMs",None)],extra=f'<div class="btn-row"><a class="btn btn-light" href="tel:{PHONE_TEL}">Call {PHONE_DISPLAY}</a></div>') + f"""
...
{areas_block(heading="Dispensary ATMs across Arizona")}
...
pr = {
 ...
 "title":"ATM Processing for Arizona ATM Owners | Arizona ATM Experts",
 "desc":"Free ATM processing with daily deposits and real-time online reporting, included with every ATM we sell or place in Arizona. Keep 100% of the surcharge on owned machines.",
 "ld":[service_ld("ATM processing", BASE+"/atm-processing.html","ATM transaction processing with daily deposits and real-time online reporting for ATM owners in Arizona."), faq_ld(PR_FAQ), crumbs_ld([("Home","index.html"),("ATM Processing","atm-processing.html")])],
}
pr["body"] = sub_hero(pr,"ATM processing","Arizona ATM processing with aggressive interchange and daily deposits","Arizona ATM Experts provides free ATM processing with each ATM we sell, and aggressive interchange for operators who bring their portfolio to us. No more waiting days for your vault cash funds, and no more guessing how much money is remaining in your ATM.","hero-processing.svg",crumbs=[("ATM Processing",None)],extra='<div class="btn-row"><a class="btn btn-light" href="#apply">Get a processing quote</a></div>') + f"""
...
<section><div class="wrap"><div class="split">
 ...
 <div>
  ...
  <p>No more waiting days for your funds to be deposited back into your account. Arizona ATM Experts makes sure your funds are deposited daily as cash is withdrawn from your ATM, settled through the Federal Reserve.</p>
...
ORIGIN_IMG = "https://idmwireless.com/wp-content/uploads/origin-1-510x382.jpg"   # IDM's product photo
def OI(fname, r): return f"{r}_assets/_images/_atm_images/{fname}"
def FB(fname, r):
    return ""
def product_card(p, depth=0):
    r = rel(depth)
    return f"""<a class="card link product" href="{r}product_pages/{p['slug']}.html"><img src="{OI(p['img'],r)}"{FB(p['img'],r)} alt="{esc(p['brand']+' '+p['name'])}{'' if p['brand'] in ('InHand','IDM Wireless') else ' ATM'}" width="500" height="500" loading="lazy"><span class="eyebrow" style="margin-bottom:.2rem">{p['brand']}</span><h3>{p['name']}</h3><p>{p['short']}</p><span class="price">{p["price"] if p.get("price") else "Reach out for current pricing"}<small>{("USD · "+p["airtime"]) if p.get("airtime") else ("USD" if p.get("price") else "")}</small></span><span class="more" style="margin-top:.75rem">View details →</span></a>"""
...
eq = {
 "path":"equipment.html",
 "title":"ATM Machines for Sale in Arizona | Genmega & Hyosung Dealer",
 "desc":"ATM machines for sale in Phoenix and across Arizona: Genmega and Nautilus Hyosung ATMs from a local Arizona ATM company. Every machine includes free processing, free shipping, and 100% of the surcharge.",
...
eq["body"] = sub_hero(eq,"ATM sales in Arizona","Buy an ATM in Arizona and keep 100% of the surcharge","Arizona ATM Experts is an authorized Genmega and Nautilus Hyosung dealer serving Phoenix and all of Arizona. We'll walk you through the entire process, from choosing a model to your first deposit.","hero-equipment.svg",crumbs=[("Buy an ATM",None)]) + f"""
...
for p in PRODUCTS:
    ...
    prod_ld = {"@context":"https://schema.org","@type":"Product","name":full+(" Wireless Modem" if p['brand']=='InHand' else "" if p['brand']=='IDM Wireless' else " ATM"),"image":OI(p["img"],BASE+"/"),"description":p['desc'],"brand":{"@type":"Brand","name":p['brand']},
    ...
    pg = {"path":f"product_pages/{p['slug']}.html","depth":1,
          "title":f"{full}{'' if p['brand'] in ('InHand','IDM Wireless') else ' ATM'} for Sale | Arizona ATM Experts",
          "desc":(p['short']+(" $"+p["price"].strip("$")+" from Arizona ATM Experts." if p.get("price") else " Free processing and shipping in Arizona. Reach out for current pricing."))[:158],
    ...
    pdf = f'<a class="btn btn-outline" href="../_assets/_pdf/{p["pdf"]}" target="_blank" rel="noopener">PDF spec sheet</a>' if p['pdf'] else ""
...
<section><div class="wrap"><div class="split" style="align-items:start">
 <img src="{OI(p['img'],"../")}"{FB(p['img'],"../")} alt="{esc(full)}" width="500" height="500" style="aspect-ratio:1;object-fit:contain;background:var(--sand);padding:1rem">
 <div class="prose">
...
# ================================================================== CITY PAGES
CITIES = [
 {"slug":"phoenix","name":"Phoenix","region":"the heart of the Valley","blurb":"Phoenix is the fifth-largest city in the country and the center of our service area. From Roosevelt Row and downtown to Arcadia, Ahwatukee, and the West Valley, we place and service more ATMs in Phoenix than anywhere else in the state.","areas":["Downtown Phoenix","Roosevelt Row","Arcadia","Biltmore","Ahwatukee","Desert Ridge","Laveen","North Phoenix"],"nearby":["scottsdale","tempe","glendale","mesa"]},
 {"slug":"scottsdale","name":"Scottsdale","region":"the East Valley","blurb":"Old Town Scottsdale's bars, nightclubs, and restaurants are some of the highest-volume ATM locations in Arizona. We also serve resorts, hotels, and retail along Scottsdale Road, in North Scottsdale, and around Kierland and the Quarter.","areas":["Old Town Scottsdale","Entertainment District","Kierland","North Scottsdale","McCormick Ranch","Scottsdale Airpark"],"nearby":["phoenix","tempe","mesa","chandler"]},
 {"slug":"tempe","name":"Tempe","region":"the East Valley","blurb":"Home to Arizona State University and the Mill Avenue district, Tempe is a cash-heavy market of bars, late-night restaurants, smoke shops, and event venues. We keep machines stocked through game days and semester rushes.","areas":["Mill Avenue","Downtown Tempe","ASU campus area","Tempe Marketplace","South Tempe"],"nearby":["phoenix","scottsdale","mesa","chandler"]},
 {"slug":"mesa","name":"Mesa","region":"the East Valley","blurb":"Mesa is Arizona's third-largest city, with a busy downtown, Cactus League ballpark traffic, and miles of retail along Main Street and the US-60. We place ATMs in Mesa bars, hotels, convenience stores, dispensaries, and city facilities.","areas":["Downtown Mesa","Dobson Ranch","Red Mountain","Superstition Springs","East Mesa","Falcon Field"],"nearby":["tempe","gilbert","chandler","scottsdale"]},
 {"slug":"chandler","name":"Chandler","region":"the East Valley","blurb":"Chandler's downtown restaurant scene, Chandler Fashion Center corridor, and fast-growing neighborhoods make it a strong ATM market. The City of Chandler is one of our municipal customers.","areas":["Downtown Chandler","Ocotillo","Chandler Fashion Center area","Sun Lakes","South Chandler"],"nearby":["gilbert","tempe","mesa","phoenix"]},
 {"slug":"gilbert","name":"Gilbert","region":"the East Valley","blurb":"Gilbert's Heritage District has become one of the Valley's busiest dining and nightlife stretches, and the town keeps growing. We place ATMs in Gilbert restaurants, bars, salons, and retail centers.","areas":["Heritage District","Downtown Gilbert","SanTan Village","Val Vista Lakes","Power Ranch"],"nearby":["chandler","mesa","tempe","queen-creek"]},
 {"slug":"glendale","name":"Glendale","region":"the West Valley","blurb":"From the Westgate Entertainment District to historic downtown Glendale, we serve bars, restaurants, hotels, and shops across the West Valley's busiest city.","areas":["Westgate","Downtown Glendale","Arrowhead","Glendale Sports & Entertainment District","North Glendale"],"nearby":["phoenix","peoria","surprise","goodyear"]},
 {"slug":"peoria","name":"Peoria","region":"the West Valley","blurb":"Peoria's P83 entertainment district, Lake Pleasant traffic, and growing north-side neighborhoods keep our West Valley routes busy. We place and service ATMs throughout Peoria.","areas":["P83 District","Old Town Peoria","Vistancia","Lake Pleasant corridor","North Peoria"],"nearby":["glendale","surprise","phoenix","goodyear"]},
 {"slug":"surprise","name":"Surprise","region":"the West Valley","blurb":"The City of Surprise is one of our municipal customers, and we serve businesses across the city from Bell Road to the spring-training area and the newer neighborhoods to the north.","areas":["Bell Road corridor","Original Town Site","Marley Park","Sun City Grand area","North Surprise"],"nearby":["peoria","glendale","goodyear","phoenix"]},
 {"slug":"goodyear","name":"Goodyear","region":"the Southwest Valley","blurb":"Goodyear, Avondale, Buckeye, and Litchfield Park are among the fastest-growing communities in Arizona, and we place ATMs in their restaurants, hotels, convenience stores, and retail centers.","areas":["Estrella","Palm Valley","Goodyear Ballpark area","Avondale","Buckeye","Litchfield Park"],"nearby":["glendale","phoenix","surprise","peoria"]},
 {"slug":"queen-creek","name":"Queen Creek","region":"the Southeast Valley","blurb":"The Town of Queen Creek is one of our municipal customers. We serve Queen Creek, San Tan Valley, and the surrounding Southeast Valley with the same free placement program we run in the city.","areas":["Queen Creek Marketplace","Downtown Queen Creek","San Tan Valley","Ironwood corridor"],"nearby":["gilbert","chandler","mesa","casa-grande"]},
 {"slug":"casa-grande","name":"Casa Grande","region":"Pinal County","blurb":"Halfway between Phoenix and Tucson, Casa Grande is a hub for travelers, outlet shoppers, and a growing local economy. The City of Casa Grande is one of our municipal customers, and we serve businesses throughout Pinal County.","areas":["Downtown Casa Grande","Promenade at Casa Grande","I-10 corridor","Maricopa","Eloy"],"nearby":["queen-creek","chandler","tucson","phoenix"]},
 {"slug":"tucson","name":"Tucson","region":"Southern Arizona","blurb":"Tucson is Arizona's second-largest city, with a vibrant downtown, the University of Arizona district, and a strong bar, restaurant, and dispensary scene. We run regular service routes to Tucson and keep machines stocked across the metro.","areas":["Downtown Tucson","4th Avenue","University of Arizona area","Oro Valley","Marana","East Tucson"],"nearby":["casa-grande","phoenix","chandler","mesa"]},
 {"slug":"prescott","name":"Prescott","region":"Northern Arizona","blurb":"Whiskey Row is one of the best-known bar districts in Arizona, and we've placed ATMs there for years. We serve Prescott, Prescott Valley, and Chino Valley with free placement, cash loading, and service.","areas":["Whiskey Row","Downtown Prescott","Prescott Valley","Chino Valley","Prescott Gateway area"],"nearby":["flagstaff","sedona","phoenix","glendale"]},
 {"slug":"sedona","name":"Sedona","region":"Northern Arizona","blurb":"Sedona's galleries, restaurants, hotels, and tour operators serve millions of visitors a year, and many of those visitors need cash. We place ATMs in Sedona and the Village of Oak Creek, and we supported the Sedona Arts Festival for years.","areas":["Uptown Sedona","West Sedona","Village of Oak Creek","Tlaquepaque area","Cottonwood"],"nearby":["flagstaff","prescott","phoenix","scottsdale"]},
 {"slug":"flagstaff","name":"Flagstaff","region":"Northern Arizona","blurb":"Flagstaff's historic downtown, Northern Arizona University, and year-round tourist traffic make it a reliable cash market. We service Flagstaff on regular northern routes alongside Sedona and Prescott.","areas":["Historic Downtown Flagstaff","NAU campus area","Southside","East Flagstaff","Route 66 corridor"],"nearby":["sedona","prescott","phoenix","scottsdale"]},
]
...
def city_page(c):
    ...
    faq=[
     ...
     (f"Do you service dispensaries in {name}?", f"<p>Yes. We're the largest cannabis ATM company in the country, and our dispensary ATMs are 100% compliant, with the dispensary's real name and address on customer bank statements. Learn more on our <a href=\"../dispensaries.html\">dispensary ATM page</a>.</p>"),
    ]
    ...
    pg={"path":f"locations/{slug}.html","depth":1,
        "title":f"Free ATM Placement in {name}, AZ | Arizona ATM Experts",
        "desc":f"Free ATM placement and ATM sales in {name}, Arizona. Arizona ATM Experts installs, cash-loads, and monitors ATMs in {name} bars, restaurants, hotels, dispensaries, and retail at no cost. Call 602.688.7447.",
        "ld":[
          {"@context":"https://schema.org","@type":"Service","name":f"ATM placement in {name}, AZ","serviceType":"ATM placement and ATM sales","url":url,
           "provider":{"@id":BASE+"/#business"},"areaServed":{"@type":"City","name":name,"containedInPlace":{"@type":"State","name":"Arizona"}},
           "description":f"Free ATM placement, cash loading, monitoring, processing, and ATM sales for businesses in {name}, Arizona."},
          faq_ld(faq),
          crumbs_ld([("Home","index.html"),("Free ATM Placement","atm-placement.html"),(f"{name}, AZ",f"locations/{slug}.html")]),
        ]}
    pg["body"]=f"""
<div class="hero sub"><div class="bg" style="background-image:url('../_assets/_images/hero-desert.svg');opacity:.5"></div><div class="wrap">
 <div class="crumbs"><a href="../index.html">Home</a><span>/</span><a href="../atm-placement.html">Free ATM Placement</a><span>/</span>{esc(name)}, AZ</div>
 <span class="eyebrow">ATM placement · {esc(name)}, Arizona</span><h1>Free ATM placement in {esc(name)}, AZ</h1>
 <p class="lead">Arizona ATM Experts places, cash-loads, and services ATMs for businesses in {esc(name)} at no cost, and sells Genmega and Hyosung machines to owners who want to keep 100% of the surcharge. Locally owned in the Phoenix metro area since 2012.</p>
...
<section><div class="wrap"><div class="split">
 <div>
  ...
  <ul class="checks">
   <li><strong>Free placement</strong> for bars, restaurants, hotels, dispensaries, C-stores, salons, and more</li>
 ...
 <img src="../_assets/_images/placement-locations.svg" alt="Business types that qualify for free ATM placement in {esc(name)}, Arizona" width="1200" height="900" loading="lazy">
</div></div></section>
...
# ================================================================== PRIVACY
pv = {"path":"privacy.html","title":"Privacy Policy | Arizona ATM Experts","desc":"How Arizona ATM Experts collects, uses, and protects information submitted through azatmexperts.com.","ld":[]}
...
<p>AZ ATM Experts ("us", "we", or "our") operates the www.azatmexperts.com website (the "Service"). This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data.</p>
...
# ================================================================== 404
nf = {"path":"404.html","title":"Page Not Found | Arizona ATM Experts","desc":"That page doesn't exist. Find ATM placement, processing, and equipment from Arizona ATM Experts.","ld":[],"noindex":True}
...
open(os.path.join(OUT,"css","styles.css"),"w").write(CSS.strip()+"\n")
...
open(os.path.join(OUT,".htaccess"),"w").write("""# Arizona ATM Experts — Apache config (safe to delete if your host isn't Apache)
RewriteEngine On
# Force https + www
RewriteCond %{HTTPS} off [OR]
RewriteCond %{HTTP_HOST} ^azatmexperts\\.com$ [NC]
RewriteRule ^(.*)$ https://www.azatmexperts.com/$1 [R=301,L]
# Retired pages
